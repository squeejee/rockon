module AuctionsHelper
  ...
  def display_nfl_player_dropdown(position_id = nil)
    @nfl_players = NflPlayer.find_by_position_id(position_id)
    detail_collection_select(:auction, :nfl_player_id, @nfl_players, :id, :display_name_with_team_code, "NFL Players", "Choose One", options ={:prompt => "--Select a player--"} ) 
  end
