class AdminsController < ApplicationController 
  ...
  def sync_nfl_players    
    @players = Hpricot.XML(open("http://football10.myfantasyleague.com/2010/export?TYPE=players&L=10423&W=")) 
  ...
  def sync_rosters
    @players = Hpricot.XML(open("http://football10.myfantasyleague.com/2010/export?TYPE=rosters&L=10423&W="))   
