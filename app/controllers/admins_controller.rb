class AdminsController < ApplicationController 
  ...
  def sync_nfl_players    
    @players = Hpricot.XML(open("http://football.myfantasyleague.com/2011/export?TYPE=players&L=&W=")) 
  ...
  def sync_rosters
    @players = Hpricot.XML(open("http://football10.myfantasyleague.com/2011/export?TYPE=rosters&L=26219&W="))   
